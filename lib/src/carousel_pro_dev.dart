...
class CarouselProDev extends StatefulWidget {
  ...
  @override
  State createState() => CarouselProDevState();
}

class CarouselProDevState extends State<CarouselProDev> {
  Timer? timer;
                              ...
                              colors: [
                                widget.overlayShadowColors != null
                                    ? widget.overlayShadowColors!
                                        .withOpacity(1.0)
                                    : Colors.grey.shade800.withOpacity(1.0),
                                widget.overlayShadowColors != null
                                    ? widget.overlayShadowColors!
                                        .withOpacity(0.0)
          ...
          child: Builder(
            builder: (_) {
              ...
              return GestureDetector(
                child: pageView,
                onDoubleTap: () => widget.onImageTap!(_currentImageIndex),
              );
            },
          ),
        ),
