...
class WidgetCarouselPro extends StatefulWidget {
  ...
  @override
  State createState() => WidgetCarouselProState();
}

class WidgetCarouselProState extends State<WidgetCarouselPro> {
